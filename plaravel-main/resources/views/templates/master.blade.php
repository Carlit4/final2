            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-3">
                    ...
                    <li class="nav-item mx-1">
                        <a class="nav-link {{ Route::is('usuarios.index') ? 'active' : '' }}" href="{{route('usuarios.index')}}">Usuarios</a>
                    </li>
                    @endif

                    @if(Gate::allows('servicios-gestion'))
                    <li class="nav-item mx-1">
                        <a class="nav-link {{ Route::is('vehiculos.index') ? 'active' : '' }}" href="{{route('vehiculos.index')}}">Vehiculos</a>
                    </li>

                    <li class="nav-item mx-1">
                        <a class="nav-link {{ Route::is('tipos.index') ? 'active' : '' }}" aria-current="page" href="{{route('tipos.index')}}">Tipos</a>
                    </li>

                    <li class="nav-item mx-1">
                        <a class="nav-link {{ Route::is('clientes.index') ? 'active' : '' }}" aria-current="page" href="{{route('clientes.index')}}">Clientes</a>
                    </li>
